...
import 'package:flutter_wallet_connect/utils/constant.dart';
import 'package:flutter_wallet_connect/utils/ethereum_conversion.dart';
import 'package:flutter_wallet_connect/widgets/input_fields.dart';
import 'package:flutter_wallet_connect/widgets/qr_scan.dart';
import 'package:flutter_wallet_connect/widgets/session_request_view.dart';
import 'package:flutter_wallet_connect/widgets/update_session_view.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Flutter Wallet Connect'),
    );
  }
}
              ...
              switch (item) {
                ...
                case MenuItems.PASTE_CODE:
                  showGeneralDialog(
                    ...
                    pageBuilder: (context, _, __) => const InputDialog(
